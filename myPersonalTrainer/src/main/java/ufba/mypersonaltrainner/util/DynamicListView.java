...
public class DynamicListView extends ListView {
    ...
    public ArrayList<Exercicio> mExercicios;
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        ExerciciosArrayAdapter adapter = ((ExerciciosArrayAdapter)getAdapter());
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mExercicios, originalItem, getPositionForView(switchView));
